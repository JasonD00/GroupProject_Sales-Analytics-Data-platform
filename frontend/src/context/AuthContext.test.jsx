/*
  Unit tests for AuthContext — covers login/logout state management
  and the hasFeature() tier-comparison logic used throughout the app
  for gating pages and charts by subscription tier.
*/
